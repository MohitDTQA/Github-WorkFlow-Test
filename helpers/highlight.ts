...
/**
 * Directly patches a Locator to automatically highlight on all interaction methods
 * Includes: click, fill, type, press, check, uncheck, selectOption, etc.
 * Does NOT use Proxy to maintain compatibility with Playwright's expect() assertions
 */
